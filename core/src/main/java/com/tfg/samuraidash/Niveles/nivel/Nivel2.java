...
public class Nivel2 implements Screen {
    ...
    public void show() {
        ...
        overlayTexture = new Texture(Gdx.files.internal("Overlays/19.png")); // Textura de overlay
        font = new BitmapFont(Gdx.files.internal("fonts/fuente.fnt")); // Fuente para texto
        backgroundTexture = new Texture("Fondos/winter 3/4.png"); // Fondo del nivel
        ...
        map = new TmxMapLoader().load("Nivel2.tmx");  // Aquí cargamos el archivo .tmx
        ...
        npcs = new Array<>();
        enemigos = new Array<>();
        samurai = new Samurai(1248, 11936); // Posición inicial del samurai
        plataformas = new Array<>();

        // Cargamos colisiones, enemigos y NPCs
        loadCollisionsFromTiles();
        loadEnemigos("niveles/Nivel2/Nivel2_Enemigos.txt");
        loadNPCs("niveles/Nivel2/Nivel2_NPC.txt");
        ...
        musicaFondo = Gdx.audio.newMusic(Gdx.files.internal("musica/nivel2.mp3"));
    ...
    private void loadEnemigosAsync() {
        new Thread(() -> {
            ...
            FileHandle file = Gdx.files.internal("niveles/Nivel2/Nivel2_Enemigos.txt");
            ...
            if (object instanceof RectangleMapObject) {
                ...
                if (samurai.getBounds().overlaps(rect)) {
                    ...
                    if (name.equals("tp")){
                        ...
                        tpSonido.play();
                        backgroundTexture = new Texture("Fondos/city 8/6.png");
