...
public class Nivel3 implements Screen {
    ...
    public void show() {
        ...
        overlayTexture = new Texture(Gdx.files.internal("Overlays/24.png")); // Textura de overlay
        font = new BitmapFont(Gdx.files.internal("fonts/fuente.fnt")); // Fuente para texto
        backgroundTexture = new Texture("Fondos/3/8.png"); // Fondo del nivel
        ...
        map = new TmxMapLoader().load("Nivel3.tmx");  // Aquí cargamos el archivo .tmx
        ...
        npcs = new Array<>();
        enemigos = new Array<>();
        samurai = new Samurai(576, 12416); // Posición inicial del samurai
        plataformas = new Array<>();

        // Cargamos colisiones, enemigos y NPCs
        loadCollisionsFromTiles();
        loadEnemigos("niveles/Nivel3/Nivel3_Enemigos.txt");
        ...
        musicaFondo = Gdx.audio.newMusic(Gdx.files.internal("musica/nivel3.mp3"));
            ...
            if (isDeathTransition) {
                ...
                if (isTransitionIn) {
                    ...
                    if (transitionTimer >= transitionDuration) {
                        ...
                        enemigos.clear();
                        loadEnemigosAsync();
                        backgroundTexture = new Texture("Fondos/3/8.png");
                        overlayTexture = new Texture(Gdx.files.internal("Overlays/24.png"));
                    }
    ...
    private void loadEnemigosAsync() {
        new Thread(() -> {
            ...
            FileHandle file = Gdx.files.internal("niveles/Nivel3/Nivel3_Enemigos.txt");
            ...
            if (object instanceof RectangleMapObject) {
                ...
                if (samurai.getBounds().overlaps(rect)) {
                    ...
                    if (name.equals("tp")){
                        ...
                        tpSonido.play();
                        backgroundTexture = new Texture("Fondos/city 2/7.png");
